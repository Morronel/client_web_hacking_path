...
const m8Networking = (() => {
  ...
  function initHttpBuilder(container) {
    ...
    if (Storage.isLabCompleted('m8', 'lab1')) {
    ...
    listen(buildBtn, 'click', () => {
      ...
      if (hasAuth && path.includes('/api/')) {
        ...
        Router.markLabComplete('m8', 'lab1');
        statusEl.textContent = '✓ Completed';
        statusEl.classList.add('solved');
      }
    });
  ...
  function initHandshake(container) {
    ...
    if (Storage.isLabCompleted('m8', 'lab2')) {
      statusEl.textContent = '✓ Completed';
      statusEl.classList.add('solved');
    }
    ...
    listen(tlsBtn, 'click', () => {
      ...
      animateMessages([
        ...
        bannerEl.classList.add('visible');
        Router.markLabComplete('m8', 'lab2');
        statusEl.textContent = '✓ Completed';
        statusEl.classList.add('solved');
      });
    });
  ...
  function initDns(container) {
    ...
    if (Storage.isLabCompleted('m8', 'lab3')) {
      statusEl.textContent = '✓ Completed';
      statusEl.classList.add('solved');
    }
    ...
    listen(resolveBtn, 'click', () => {
      ...
      if (records) {
        ...
        if (domain === 'app.example.com') {
          bannerEl.classList.add('visible');
          Router.markLabComplete('m8', 'lab3');
          statusEl.textContent = '✓ Completed';
          statusEl.classList.add('solved');
        }
      } else {
  ...
  function initSop(container) {
    ...
    if (Storage.isLabCompleted('m8', 'lab4')) {
      statusEl.textContent = '✓ Completed';
      statusEl.classList.add('solved');
    }
    ...
    listen(checkBtn, 'click', () => {
      ...
      if (sopChecks >= 3) {
        bannerEl.classList.add('visible');
        Router.markLabComplete('m8', 'lab4');
        statusEl.textContent = '✓ Completed';
        statusEl.classList.add('solved');
      }
    });
  ...
  function initCidr(container) {
    ...
    if (Storage.isLabCompleted('m8', 'lab5')) {
      statusEl.textContent = '✓ Completed';
      statusEl.classList.add('solved');
    }
    ...
    listen(calcBtn, 'click', () => {
      ...
      if (cidrCalcs >= 2) {
        bannerEl.classList.add('visible');
        Router.markLabComplete('m8', 'lab5');
        statusEl.textContent = '✓ Completed';
        statusEl.classList.add('solved');
      }
    });
...
window.m8Networking = m8Networking;
